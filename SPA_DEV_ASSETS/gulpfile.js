...
//Location
var indexLocation = "./../SOURCE/index.html",
    scriptsLocation = ['js/**/*.js', '!js/tests/**/*.js'],
    filesToCopyLocation = ['js/**/*.html', 'js/**/*.json'],
    stylesLocation = ['css/**/*.less', 'js/**/*.less', '!css/theme/*'],
    imagesLocation = ['img/**/*'];
//Destination
var indexDestination = "./../SOURCE/",
    scriptsBaseDestination = './../SOURCE/main/webapp/app/js',
    pluginsScriptsDestination = "./../SOURCE/main/webapp/app/js/lib/",
    stylesBaseDestination = './../SOURCE/main/webapp/app/css',
    imagesDestination = './../SOURCE/main/webapp/app/img/';
//Args
...
gulp.task('clean',function(){
    return gulp.src('./../SOURCE/main/webapp/app/*', {read: false})
